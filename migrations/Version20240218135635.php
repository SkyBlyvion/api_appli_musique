...
final class Version20240218135635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE playlist_song (id INT AUTO_INCREMENT NOT NULL, playlist_id_id INT DEFAULT NULL, song_id_id INT DEFAULT NULL, INDEX IDX_93F4D9C3DC588714 (playlist_id_id), INDEX IDX_93F4D9C3B2E00B12 (song_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
